...
# Based on Kaldi preparation recipes
...
if [ $# -ne 6 ]; then
  ...
  echo "Example usage: shutil/chain/estimate_e2e_phone_lm.sh data/lang_lp exp/chain/e2e_tree data/train_spe2e_hires true biphone lang_e2e_biphone"
  exit 1
fi
